...
Original file is located at
    https://colab.research.google.com/drive/13m3t3Ddka_hZ64kQhuF9xQafTfhvtfPY
...
df = df[['NumDots', 'PathLevel', 'UrlLength', 'NumDash', 'NumDashInHostname',
...
clf = tree.DecisionTreeClassifier(criterion='gini', max_depth= None, min_samples_leaf= 1, min_samples_split= 7,splitter='best')
